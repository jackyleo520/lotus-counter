...
# 1. 更新心经为《佛说圣佛母般若波罗蜜多经》
new_heart = "佛说圣佛母般若波罗蜜多经\n\n如是我闻：一时薄伽梵在王舍城鹫峰山中，与大苾刍众千二百五十人俱，皆是大阿罗汉，众所知识。尔时世尊等入甚深明了三摩地法之异门。复于尔时，观自在菩萨摩诃萨行深般若波罗蜜多时，观察照见五蕴体性，悉皆是空。\n\n时具寿舍利子，承佛威力，白圣者观自在菩萨摩诃萨曰：若善男子，欲修行甚深般若波罗蜜多者，复当云何修学？作是语已，观自在菩萨摩诃萨答具寿舍利子言：舍利子！若善男子及善女人，欲修行甚深般若波罗蜜多者，彼应如是观察，五蕴体性皆空。色即是空，空即是色，色不异空，空不异色，如是受想行识，亦复皆空。\n\n是故舍利子！一切法空性无相，不生不灭，不垢不净，不增不减。是故空性之中无色、无受、无想、无行、亦无有识。无眼、无耳、无鼻、无舌、无身、无意。无色、无声、无香、无味、无触、无法。无眼界，乃至无意识界。无无明，亦无无明尽，乃至无老死，亦无老死尽。无苦集灭道。无智亦无得，以无所得故。\n\n菩提萨埵依般若波罗蜜多故，心无挂碍；无挂碍故，无有恐怖，远离颠倒梦想，究竟涅槃。三世诸佛依般若波罗蜜多故，得阿耨多罗三藐三菩提。故知般若波罗蜜多，是大神咒，是大明咒，是无上咒，是无等等咒，能除一切苦，真实不虚。故说般若波罗蜜多咒，即说咒曰：揭谛揭谛，波罗揭谛，波罗僧揭谛，菩提莎诃。"

old_heart_pattern = r'const HEART_SUTRA = ".*?";'
content = re.sub(old_heart_pattern, 'const HEART_SUTRA = "' + new_heart.replace('\\', '\\\\').replace('"', '\\"').replace('\n', '\\n') + '";', content, flags=re.DOTALL)
print("心经已更新为《佛说圣佛母般若波罗蜜多经》")

# 2. 更新金刚经为完整版（32品）
diamond_full = r"""金刚般若波罗蜜经
...
时长老须菩提在大众中，即从座起，偏袒右肩，右膝著地，合掌恭敬而白佛言：希有世尊！如来善护念诸菩萨，善付嘱诸菩萨。世尊！善男子、善女人，发阿耨多罗三藐三菩提心，云何应住，云何降伏其心？佛言：善哉善哉！须菩提，如汝所说，如来善护念诸菩萨，善付嘱诸菩萨。汝今谛听，当为汝说。善男子、善女人，发阿耨多罗三藐三菩提心，应如是住，如是降伏其心。唯然世尊，愿乐欲闻。
...
须菩提！于意云何？可以三十二相观如来不？须菩提言：如是！如是！以三十二相观如来。佛言：须菩提！若以三十二相观如来者，转轮圣王则是如来。须菩提白佛言：世尊！如我解佛所说义，不应以三十二相观如来。尔时，世尊而说言：若以色见我，以音声求我，是人行邪道，不能见如来。
...
# 替换金刚经
diamond_pattern = r'\{ name: "金刚经", content: ".*?" \}'
diamond_match = re.search(diamond_pattern, content, re.DOTALL)
if diamond_match:
    old_diamond = diamond_match.group(0)
    escaped_diamond = diamond_full.replace('\\', '\\\\').replace('"', '\\"').replace('\n', '\\n').replace('\r', '')
    new_diamond = '{ name: "金刚经", content: "' + escaped_diamond + '" }'
    content = content.replace(old_diamond, new_diamond)
    print("金刚经已更新为完整版（32品）")
else:
    print("未找到金刚经")
