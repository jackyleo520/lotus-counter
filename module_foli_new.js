...
//            lObj.innerHTML = '<b>'+(cld[sD].isLeap?'闰':'') + cld[sD].lMonth + '月' + (monthDays(cld[sD].lYear,cld[sD].lMonth)==29?'小':'大')+'</b>';
            lObj.innerHTML = '<b>'+(cld[sD].isLeap?'闰':'') + nStr3[cld[sD].lMonth] + '月' + ((cld[sD].isLeap?leapDays(cld[sD].lYear):monthDays(cld[sD].lYear,cld[sD].lMonth))==29?'小':'大')+'</b>'; //釋慧剛 - 用漢字數字顯示農歷月份並更正閏月大小顯示錯誤
         else //显示农历日
